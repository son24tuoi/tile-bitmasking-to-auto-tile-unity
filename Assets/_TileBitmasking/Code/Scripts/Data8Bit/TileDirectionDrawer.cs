...
namespace TileBitmasking.Data8Bit.Attribute
{
    ...
    public class TileDirectionDrawer : PropertyDrawer
    {
        ...
        {
            TileDirection.NorthWest, TileDirection.North, TileDirection.NorthEast,
            TileDirection.West,      TileDirection.None,  TileDirection.East,
            TileDirection.SouthWest, TileDirection.South, TileDirection.SouthEast
        };
